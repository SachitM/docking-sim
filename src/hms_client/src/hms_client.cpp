...
int main(int argc, char** argv)
{
  ...
  for (int i = 0; i < num_topics; i++)
  {
    ...
    {
      case 0:
        subs.push_back(nh.subscribe(topics[i], cb_queue, PointCloud2_callback));
        break;
      case 1:
        subs.push_back(nh.subscribe(topics[i], cb_queue, LaserScan_callback));
        break;
      case 2:
        subs.push_back(nh.subscribe(topics[i], cb_queue, ndt_pose_callback));
        break;
    }
  }
